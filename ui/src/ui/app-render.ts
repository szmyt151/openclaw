        ...
        ${
          state.tab === "channels"
            ? renderChannels({
                ...
                onPairingToggle: () => (state.pairingCenterExpanded = !state.pairingCenterExpanded),
        ...
        ${
          state.tab === "cron"
            ? renderCron({
                ...
                runs: state.cronRuns,
                filterMode: state.cronFilterMode,
                searchQuery: state.cronSearchQuery,
                lastRunsExpanded: state.cronLastRunsExpanded,
