...
export function renderChannelsAccounts({ snapshot, expanded, onToggle, onViewInGraph }: Props) {
                  ...
                  <tr style="border-bottom: 1px solid var(--border-color); ${index % 2 === 0 ? "background: var(--bg-secondary);" : ""}">
                    ...
                    <td style="padding: 8px;">
                      ${
                        account.enabled
                          ? html`
                              <span style="color: #0a7f3f">✓</span>
                            `
                          : html`
                              <span style="color: #8a1c1c">✗</span>
                            `
                      }
                    </td>
                    <td style="padding: 8px;">
                    ...
                    ${
                      ...
                      <td style="padding: 8px;">
                        <button
                          ...
                          @click=${() => onViewInGraph(`${account.channel}:${account.accountId}`)}
                          title="View this account in Agent Graph"
                        >
                          View in Graph
                        </button>
                      </td>
